...
const MovieComment: React.FC<MovieCommentProps> = (props) => {
    ...
    return (
        <div className="flex flex-col py-2 px-4 shadow-xl rounded-xl border-[1px] lg:w-4/5 w-full min-w-fit-content flex-wrap">
            <div className="flex flex-row flex-wrap justify-between gap-3">
                <div className="inline-flex felx-row items-center gap-3">
                    <AvatarBySrc src={props.author?.avatar_url} />
                    <Breadcrumbs separator={<PiDotBold />}>
                        <Typography className="dark:text-white !font-MP_Medium sm:!text-base !text-sm">
